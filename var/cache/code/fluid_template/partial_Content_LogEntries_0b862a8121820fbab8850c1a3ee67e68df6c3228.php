...
class partial_Content_LogEntries_0b862a8121820fbab8850c1a3ee67e68df6c3228 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments687 = array();
$arguments687['route'] = NULL;
$arguments687['arguments'] = array (
);
$arguments687['query'] = NULL;
$arguments687['currentUrlParameterName'] = NULL;
$arguments687['route'] = 'record_history';
// Rendering Array
$array689 = array();
$array690 = array (
);$array689['historyEntry'] = $renderingContext->getVariableProvider()->getByPath('logItem.logData.history', $array690);
$arguments687['arguments'] = $array689;

$output686 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [TYPO3\CMS\Backend\ViewHelpers\ModuleLinkViewHelper::renderStatic($arguments687, $renderChildrenClosure688, $renderingContext)]);
...
$arguments691['key'] = 'showHistory';

$output686 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments691, $renderChildrenClosure692, $renderingContext)]);
...
$arguments693 = array();
$arguments693['identifier'] = NULL;
$arguments693['size'] = 'small';
$arguments693['overlay'] = NULL;
$arguments693['state'] = 'default';
$arguments693['alternativeMarkupIdentifier'] = NULL;
$arguments693['identifier'] = 'actions-document-history-open';

$output686 .= TYPO3\CMS\Core\ViewHelpers\IconViewHelper::renderStatic($arguments693, $renderChildrenClosure694, $renderingContext);
...
$array683 = array();
$array684 = array (
);$array683['0'] = $renderingContext->getVariableProvider()->getByPath('logItem.logData.history', $array684);

$expression685 = function($context) {return TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]);};
...
$output700 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('logItem.type', $array701)]);

$output700 .= '.';
$array702 = array (
);
$output700 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('logItem.action', $array702)]);

$output700 .= '.';
$array703 = array (
);
$output700 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('logItem.detailsNumber', $array703)]);
...
$array697 = array();
$array698 = array (
);$array697['0'] = $renderingContext->getVariableProvider()->getByPath('logItem.detailsNumber', $array698);
$array697['1'] = ' > 0';

$expression699 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) > 0);};
...
$output473 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments695, $renderChildrenClosure696, $renderingContext);
...
$arguments715['languageKey'] = NULL;
$arguments715['alternativeLanguageKeys'] = NULL;
$arguments715['key'] = 'actions.deleteWarnings';

$output714 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments715, $renderChildrenClosure716, $renderingContext)]);
...
$arguments710['name'] = NULL;
$arguments710['rel'] = NULL;
$arguments710['rev'] = NULL;
$arguments710['target'] = NULL;
$arguments710['action'] = NULL;
$arguments710['controller'] = NULL;
$arguments710['extensionName'] = NULL;
$arguments710['pluginName'] = NULL;
$arguments710['pageUid'] = NULL;
$arguments710['pageType'] = NULL;
$arguments710['noCache'] = NULL;
$arguments710['noCacheHash'] = NULL;
$arguments710['section'] = NULL;
$arguments710['format'] = NULL;
$arguments710['linkAccessRestrictedPages'] = NULL;
$arguments710['additionalParams'] = NULL;
$arguments710['absolute'] = NULL;
$arguments710['addQueryString'] = NULL;
$arguments710['argumentsToBeExcludedFromQueryString'] = NULL;
$arguments710['addQueryStringMethod'] = NULL;
$arguments710['arguments'] = NULL;
$arguments710['action'] = 'deleteMessage';
// Rendering Array
$array712 = array();
$array713 = array (
);$array712['errorUid'] = $renderingContext->getVariableProvider()->getByPath('logItem.uid', $array713);
$arguments710['arguments'] = $array712;
$arguments710['class'] = 'btn btn-warning';

$output709 .= TYPO3\CMS\Fluid\ViewHelpers\Link\ActionViewHelper::renderStatic($arguments710, $renderChildrenClosure711, $renderingContext);
...
$array706 = array();
$array707 = array (
);$array706['0'] = $renderingContext->getVariableProvider()->getByPath('logItem.error', $array707);
$array706['1'] = ' == 1';

$expression708 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 1);};
...
$output473 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments704, $renderChildrenClosure705, $renderingContext);
...
$arguments728['key'] = 'actions.delete';
...
$arguments723['action'] = 'deleteMessage';
// Rendering Array
$array725 = array();
$array726 = array (
);$array725['errorUid'] = $renderingContext->getVariableProvider()->getByPath('logItem.uid', $array726);
$arguments723['arguments'] = $array725;
$arguments723['class'] = 'btn btn-danger';
...
$array719 = array();
$array720 = array (
);$array719['0'] = $renderingContext->getVariableProvider()->getByPath('logItem.error', $array720);
$array719['1'] = ' == 2';

$expression721 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 2);};
...
$output473 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments717, $renderChildrenClosure718, $renderingContext);
